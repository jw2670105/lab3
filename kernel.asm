...
801009cb:	0f 84 c1 01 00 00    	je     80100b92 <exec+0x1f2>
    end_op();
    cprintf("exec: fail\n");
    return -1;
  }
...
80100b40:	e8 4b 20 00 00       	call   80102b90 <end_op>
  curproc->stkpages = NEWPG;
80100b45:	8b 85 f4 fe ff ff    	mov    -0x10c(%ebp),%eax
80100b4b:	c7 40 7c 00 f0 ff 7f 	movl   $0x7ffff000,0x7c(%eax)
  if((sz = allocuvm(pgdir, NEWPG - PGSIZE, NEWPG)) == 0)
80100b52:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
80100b58:	c7 44 24 08 00 f0 ff 	movl   $0x7ffff000,0x8(%esp)
80100b5f:	7f 
...
80100b72:	89 85 e8 fe ff ff    	mov    %eax,-0x118(%ebp)
80100b78:	75 33                	jne    80100bad <exec+0x20d>
    freevm(pgdir);
80100b7a:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
80100b80:	89 04 24             	mov    %eax,(%esp)
80100b83:	e8 38 5e 00 00       	call   801069c0 <freevm>
  return -1;
80100b88:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80100b8d:	e9 80 fe ff ff       	jmp    80100a12 <exec+0x72>
    end_op();
80100b92:	e8 f9 1f 00 00       	call   80102b90 <end_op>
    cprintf("exec: fail\n");
80100b97:	c7 04 24 c1 6e 10 80 	movl   $0x80106ec1,(%esp)
80100b9e:	e8 ad fa ff ff       	call   80100650 <cprintf>
    return -1;
80100ba3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80100ba8:	e9 65 fe ff ff       	jmp    80100a12 <exec+0x72>
  clearpteu(pgdir, (char*)(sz - 2*PGSIZE));
80100bad:	8b 85 e8 fe ff ff    	mov    -0x118(%ebp),%eax
80100bb3:	2d 00 20 00 00       	sub    $0x2000,%eax
80100bb8:	89 44 24 04          	mov    %eax,0x4(%esp)
80100bbc:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
80100bc2:	89 04 24             	mov    %eax,(%esp)
80100bc5:	e8 26 5f 00 00       	call   80106af0 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
80100bca:	8b 45 0c             	mov    0xc(%ebp),%eax
80100bcd:	8b 00                	mov    (%eax),%eax
80100bcf:	85 c0                	test   %eax,%eax
80100bd1:	0f 84 5c 01 00 00    	je     80100d33 <exec+0x393>
80100bd7:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80100bda:	31 d2                	xor    %edx,%edx
  sp = NEWPG;
80100bdc:	bb 00 f0 ff 7f       	mov    $0x7ffff000,%ebx
80100be1:	8d 71 04             	lea    0x4(%ecx),%esi
  for(argc = 0; argv[argc]; argc++) {
80100be4:	89 cf                	mov    %ecx,%edi
80100be6:	89 d1                	mov    %edx,%ecx
80100be8:	89 f2                	mov    %esi,%edx
80100bea:	89 fe                	mov    %edi,%esi
80100bec:	89 cf                	mov    %ecx,%edi
80100bee:	eb 08                	jmp    80100bf8 <exec+0x258>
80100bf0:	83 c2 04             	add    $0x4,%edx
    if(argc >= MAXARG)
80100bf3:	83 ff 20             	cmp    $0x20,%edi
80100bf6:	74 82                	je     80100b7a <exec+0x1da>
...
80100c38:	0f 88 3c ff ff ff    	js     80100b7a <exec+0x1da>
  for(argc = 0; argv[argc]; argc++) {
...
80100cab:	0f 88 c9 fe ff ff    	js     80100b7a <exec+0x1da>
  for(last=s=path; *s; s++)
...
80100d27:	e8 94 5c 00 00       	call   801069c0 <freevm>
  return 0;
80100d2c:	31 c0                	xor    %eax,%eax
80100d2e:	e9 df fc ff ff       	jmp    80100a12 <exec+0x72>
  sp = NEWPG;
80100d33:	bb 00 f0 ff 7f       	mov    $0x7ffff000,%ebx
  for(argc = 0; argv[argc]; argc++) {
...
80100d56:	c7 44 24 04 cd 6e 10 	movl   $0x80106ecd,0x4(%esp)
80100d5d:	80 
...
80100e16:	c3                   	ret    
    panic("filedup");
80100e17:	c7 04 24 d4 6e 10 80 	movl   $0x80106ed4,(%esp)
...
80100ed7:	e9 b4 1c 00 00       	jmp    80102b90 <end_op>
    panic("fileclose");
80100edc:	c7 04 24 dc 6e 10 80 	movl   $0x80106edc,(%esp)
...
80100fc5:	eb d8                	jmp    80100f9f <fileread+0x5f>
  panic("fileread");
80100fc7:	c7 04 24 e6 6e 10 80 	movl   $0x80106ee6,(%esp)
...
801010dc:	e9 1f 22 00 00       	jmp    80103300 <pipewrite>
        panic("short filewrite");
801010e1:	c7 04 24 ef 6e 10 80 	movl   $0x80106eef,(%esp)
801010e8:	e8 73 f2 ff ff       	call   80100360 <panic>
  panic("filewrite");
801010ed:	c7 04 24 f5 6e 10 80 	movl   $0x80106ef5,(%esp)
...
801011a5:	c7 04 24 ff 6e 10 80 	movl   $0x80106eff,(%esp)
...
801012cd:	c7 04 24 15 6f 10 80 	movl   $0x80106f15,(%esp)
...
80101385:	eb 93                	jmp    8010131a <bmap+0x3a>
  panic("bmap: out of range");
80101387:	c7 04 24 25 6f 10 80 	movl   $0x80106f25,(%esp)
...
80101469:	c7 04 24 38 6f 10 80 	movl   $0x80106f38,(%esp)
...
8010148c:	c7 44 24 04 4b 6f 10 	movl   $0x80106f4b,0x4(%esp)
80101493:	80 
...
801014a9:	c7 44 24 04 52 6f 10 	movl   $0x80106f52,0x4(%esp)
801014b0:	80 
...
801014d6:	c7 04 24 b8 6f 10 80 	movl   $0x80106fb8,(%esp)
...
801015f1:	c7 04 24 58 6f 10 80 	movl   $0x80106f58,(%esp)
...
80101774:	0f 85 76 ff ff ff    	jne    801016f0 <ilock+0x30>
      panic("ilock: no type");
8010177a:	c7 04 24 70 6f 10 80 	movl   $0x80106f70,(%esp)
80101781:	e8 da eb ff ff       	call   80100360 <panic>
    panic("ilock");
80101786:	c7 04 24 6a 6f 10 80 	movl   $0x80106f6a,(%esp)
...
801017ce:	e9 1d 28 00 00       	jmp    80103ff0 <releasesleep>
    panic("iunlock");
801017d3:	c7 04 24 7f 6f 10 80 	movl   $0x80106f7f,(%esp)
...
80101c71:	c3                   	ret    
      panic("dirlookup read");
80101c72:	c7 04 24 99 6f 10 80 	movl   $0x80106f99,(%esp)
80101c79:	e8 e2 e6 ff ff       	call   80100360 <panic>
    panic("dirlookup not DIR");
80101c7e:	c7 04 24 87 6f 10 80 	movl   $0x80106f87,(%esp)
...
80101ef3:	eb e9                	jmp    80101ede <dirlink+0xae>
      panic("dirlink read");
80101ef5:	c7 04 24 a8 6f 10 80 	movl   $0x80106fa8,(%esp)
80101efc:	e8 5f e4 ff ff       	call   80100360 <panic>
    panic("dirlink");
80101f01:	c7 04 24 a6 75 10 80 	movl   $0x801075a6,(%esp)
...
80101fef:	c7 04 24 14 70 10 80 	movl   $0x80107014,(%esp)
80101ff6:	e8 65 e3 ff ff       	call   80100360 <panic>
    panic("idestart");
80101ffb:	c7 04 24 0b 70 10 80 	movl   $0x8010700b,(%esp)
...
80102016:	c7 44 24 04 26 70 10 	movl   $0x80107026,0x4(%esp)
8010201d:	80 
...
801021e9:	eb bb                	jmp    801021a6 <iderw+0x76>
    panic("iderw: buf not locked");
801021eb:	c7 04 24 2a 70 10 80 	movl   $0x8010702a,(%esp)
801021f2:	e8 69 e1 ff ff       	call   80100360 <panic>
    panic("iderw: ide disk 1 not present");
801021f7:	c7 04 24 55 70 10 80 	movl   $0x80107055,(%esp)
801021fe:	e8 5d e1 ff ff       	call   80100360 <panic>
    panic("iderw: nothing to do");
80102203:	c7 04 24 40 70 10 80 	movl   $0x80107040,(%esp)
...
80102258:	c7 04 24 74 70 10 80 	movl   $0x80107074,(%esp)
...
8010238c:	eb bb                	jmp    80102349 <kfree+0x49>
    panic("kfree");
8010238e:	c7 04 24 a6 70 10 80 	movl   $0x801070a6,(%esp)
...
801023fb:	c7 44 24 04 ac 70 10 	movl   $0x801070ac,0x4(%esp)
80102402:	80 
...
80102544:	0f b6 81 e0 71 10 80 	movzbl -0x7fef8e20(%ecx),%eax
...
80102578:	0f b6 91 e0 71 10 80 	movzbl -0x7fef8e20(%ecx),%edx
  shift ^= togglecode[data];
8010257f:	0f b6 81 e0 70 10 80 	movzbl -0x7fef8f20(%ecx),%eax
  shift |= shiftcode[data];
...
8010258f:	8b 04 85 c0 70 10 80 	mov    -0x7fef8f40(,%eax,4),%eax
  shift ^= togglecode[data];
...
80102a8b:	c7 44 24 04 e0 72 10 	movl   $0x801072e0,0x4(%esp)
80102a92:	80 
...
80102cb2:	c3                   	ret    
    panic("log.committing");
80102cb3:	c7 04 24 e4 72 10 80 	movl   $0x801072e4,(%esp)
...
80102d6d:	8d 76 00             	lea    0x0(%esi),%esi
    panic("too big a transaction");
80102d70:	c7 04 24 f3 72 10 80 	movl   $0x801072f3,(%esp)
80102d77:	e8 e4 d5 ff ff       	call   80100360 <panic>
    panic("log_write outside of trans");
80102d7c:	c7 04 24 09 73 10 80 	movl   $0x80107309,(%esp)
...
80102da7:	c7 04 24 24 73 10 80 	movl   $0x80107324,(%esp)
...
80102e55:	e8 56 3f 00 00       	call   80106db0 <shminit>
  tvinit();        // trap vectors
...
80102f4f:	00 
80102f50:	c7 44 24 04 38 73 10 	movl   $0x80107338,0x4(%esp)
80102f57:	80 
...
8010300a:	00 
8010300b:	c7 44 24 04 3d 73 10 	movl   $0x8010733d,0x4(%esp)
80103012:	80 
...
8010309c:	ff 24 8d 7c 73 10 80 	jmp    *-0x7fef8c84(,%ecx,4)
801030a3:	90                   	nop
...
80103127:	0f 85 c5 fe ff ff    	jne    80102ff2 <mpinit+0x52>
    panic("Expect to run on an SMP");
8010312d:	c7 04 24 42 73 10 80 	movl   $0x80107342,(%esp)
...
80103148:	eb e3                	jmp    8010312d <mpinit+0x18d>
    panic("Didn't find a suitable machine");
8010314a:	c7 04 24 5c 73 10 80 	movl   $0x8010735c,(%esp)
...
801031ef:	c7 44 24 04 90 73 10 	movl   $0x80107390,0x4(%esp)
801031f6:	80 
...
801035f6:	c7 44 24 04 95 73 10 	movl   $0x80107395,0x4(%esp)
801035fd:	80 
...
8010366a:	c7 04 24 9c 73 10 80 	movl   $0x8010739c,(%esp)
80103671:	e8 ea cc ff ff       	call   80100360 <panic>
    panic("mycpu called with interrupts enabled\n");
80103676:	c7 04 24 78 74 10 80 	movl   $0x80107478,(%esp)
...
801036fd:	0f 84 db 00 00 00    	je     801037de <userinit+0xfe>
...
80103788:	8d 43 6c             	lea    0x6c(%ebx),%eax
  p->stkpages = 0;
8010378b:	c7 43 7c 00 00 00 00 	movl   $0x0,0x7c(%ebx)
  safestrcpy(p->name, "initcode", sizeof(p->name));
80103792:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80103799:	00 
8010379a:	c7 44 24 04 c5 73 10 	movl   $0x801073c5,0x4(%esp)
801037a1:	80 
801037a2:	89 04 24             	mov    %eax,(%esp)
801037a5:	e8 c6 0c 00 00       	call   80104470 <safestrcpy>
  p->cwd = namei("/");
801037aa:	c7 04 24 ce 73 10 80 	movl   $0x801073ce,(%esp)
801037b1:	e8 5a e7 ff ff       	call   80101f10 <namei>
801037b6:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
801037b9:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801037c0:	e8 8b 09 00 00       	call   80104150 <acquire>
  p->state = RUNNABLE;
801037c5:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
801037cc:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801037d3:	e8 68 0a 00 00       	call   80104240 <release>
}
801037d8:	83 c4 14             	add    $0x14,%esp
801037db:	5b                   	pop    %ebx
801037dc:	5d                   	pop    %ebp
801037dd:	c3                   	ret    
    panic("userinit: out of memory?");
801037de:	c7 04 24 ac 73 10 80 	movl   $0x801073ac,(%esp)
801037e5:	e8 76 cb ff ff       	call   80100360 <panic>
...
8010387c:	0f 84 c4 00 00 00    	je     80103946 <fork+0xe6>
  if((np->pgdir = copyuvm(curproc->pgdir, curproc->sz, curproc->stkpages)) == 0){
...
80103a7e:	c7 04 24 d0 73 10 80 	movl   $0x801073d0,(%esp)
80103a85:	e8 d6 c8 ff ff       	call   80100360 <panic>
    panic("sched interruptible");
80103a8a:	c7 04 24 fc 73 10 80 	movl   $0x801073fc,(%esp)
80103a91:	e8 ca c8 ff ff       	call   80100360 <panic>
    panic("sched running");
80103a96:	c7 04 24 ee 73 10 80 	movl   $0x801073ee,(%esp)
80103a9d:	e8 be c8 ff ff       	call   80100360 <panic>
    panic("sched locks");
80103aa2:	c7 04 24 e2 73 10 80 	movl   $0x801073e2,(%esp)
...
80103ba6:	e8 65 fe ff ff       	call   80103a10 <sched>
  panic("zombie exit");
80103bab:	c7 04 24 1d 74 10 80 	movl   $0x8010741d,(%esp)
80103bb2:	e8 a9 c7 ff ff       	call   80100360 <panic>
    panic("init exiting");
80103bb7:	c7 04 24 10 74 10 80 	movl   $0x80107410,(%esp)
...
80103c9e:	c7 04 24 2f 74 10 80 	movl   $0x8010742f,(%esp)
80103ca5:	e8 b6 c6 ff ff       	call   80100360 <panic>
    panic("sleep");
80103caa:	c7 04 24 29 74 10 80 	movl   $0x80107429,(%esp)
...
80103e94:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103e98:	c7 04 24 07 78 10 80 	movl   $0x80107807,(%esp)
...
80103eba:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80103ebd:	ba 40 74 10 80       	mov    $0x80107440,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80103ec2:	77 11                	ja     80103ed5 <procdump+0x55>
80103ec4:	8b 14 85 a0 74 10 80 	mov    -0x7fef8b60(,%eax,4),%edx
      state = "???";
80103ecb:	b8 40 74 10 80       	mov    $0x80107440,%eax
...
80103ee0:	c7 04 24 44 74 10 80 	movl   $0x80107444,(%esp)
...
80103f5a:	c7 44 24 04 b8 74 10 	movl   $0x801074b8,0x4(%esp)
80103f61:	80 
...
801041b7:	eb ac                	jmp    80104165 <acquire+0x15>
    panic("acquire");
801041b9:	c7 04 24 c3 74 10 80 	movl   $0x801074c3,(%esp)
...
80104219:	c3                   	ret    
    panic("popcli");
8010421a:	c7 04 24 e2 74 10 80 	movl   $0x801074e2,(%esp)
80104221:	e8 3a c1 ff ff       	call   80100360 <panic>
    panic("popcli - interruptible");
80104226:	c7 04 24 cb 74 10 80 	movl   $0x801074cb,(%esp)
...
8010424f:	75 0f                	jne    80104260 <release+0x20>
    panic("release");
80104251:	c7 04 24 e9 74 10 80 	movl   $0x801074e9,(%esp)
...
8010464d:	8b 14 85 20 75 10 80 	mov    -0x7fef8ae0(,%eax,4),%edx
...
80104676:	c7 04 24 f1 74 10 80 	movl   $0x801074f1,(%esp)
...
80104800:	c7 44 24 04 9c 75 10 	movl   $0x8010759c,0x4(%esp)
80104807:	80 
...
8010481b:	c7 44 24 04 9b 75 10 	movl   $0x8010759b,0x4(%esp)
80104822:	80 
...
80104831:	79 89                	jns    801047bc <create+0xdc>
      panic("create dots");
80104833:	c7 04 24 8f 75 10 80 	movl   $0x8010758f,(%esp)
8010483a:	e8 21 bb ff ff       	call   80100360 <panic>
    panic("create: dirlink");
8010483f:	c7 04 24 9e 75 10 80 	movl   $0x8010759e,(%esp)
80104846:	e8 15 bb ff ff       	call   80100360 <panic>
    panic("create: ialloc");
8010484b:	c7 04 24 80 75 10 80 	movl   $0x80107580,(%esp)
...
80104bf1:	c7 44 24 04 9c 75 10 	movl   $0x8010759c,0x4(%esp)
80104bf8:	80 
...
80104c09:	c7 44 24 04 9b 75 10 	movl   $0x8010759b,0x4(%esp)
80104c10:	80 
...
80104d5d:	c7 04 24 c0 75 10 80 	movl   $0x801075c0,(%esp)
80104d64:	e8 f7 b5 ff ff       	call   80100360 <panic>
    panic("unlink: writei");
80104d69:	c7 04 24 d2 75 10 80 	movl   $0x801075d2,(%esp)
80104d70:	e8 eb b5 ff ff       	call   80100360 <panic>
    panic("unlink: nlink < 1");
80104d75:	c7 04 24 ae 75 10 80 	movl   $0x801075ae,(%esp)
...
80105229:	e8 e2 1b 00 00       	call   80106e10 <shm_open>
}
8010522e:	c9                   	leave  
8010522f:	c3                   	ret    
    return -1;
...
80105263:	e8 b8 1b 00 00       	call   80106e20 <shm_close>
}
80105268:	c9                   	leave  
80105269:	c3                   	ret    
...
801054a9:	c7 44 24 04 e1 75 10 	movl   $0x801075e1,0x4(%esp)
801054b0:	80 
...
80105540:	ff 24 85 88 76 10 80 	jmp    *-0x7fef8978(,%eax,4)
80105547:	90                   	nop
    lapiceoi();
    break;
...
8010554f:	90                   	nop
80105550:	0f 84 6a 02 00 00    	je     801057c0 <trap+0x2a0>
80105556:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
8010555a:	0f 84 60 02 00 00    	je     801057c0 <trap+0x2a0>
...
801055b3:	c7 04 24 44 76 10 80 	movl   $0x80107644,(%esp)
...
80105665:	8b 40 7c             	mov    0x7c(%eax),%eax
80105668:	f7 d8                	neg    %eax
8010566a:	c1 e0 0c             	shl    $0xc,%eax
8010566d:	8d b0 00 f0 ff 7f    	lea    0x7ffff000(%eax),%esi
80105673:	e8 38 e0 ff ff       	call   801036b0 <myproc>
80105678:	8b 40 7c             	mov    0x7c(%eax),%eax
8010567b:	f7 d8                	neg    %eax
8010567d:	c1 e0 0c             	shl    $0xc,%eax
80105680:	8d b8 00 e0 ff 7f    	lea    0x7fffe000(%eax),%edi
80105686:	e8 25 e0 ff ff       	call   801036b0 <myproc>
8010568b:	89 74 24 08          	mov    %esi,0x8(%esp)
8010568f:	89 7c 24 04          	mov    %edi,0x4(%esp)
80105693:	8b 40 04             	mov    0x4(%eax),%eax
80105696:	89 04 24             	mov    %eax,(%esp)
80105699:	e8 02 12 00 00       	call   801068a0 <allocuvm>
8010569e:	85 c0                	test   %eax,%eax
801056a0:	0f 84 2a ff ff ff    	je     801055d0 <trap+0xb0>
  	myproc()->stkpages++;
801056a6:	e8 05 e0 ff ff       	call   801036b0 <myproc>
801056ab:	83 40 7c 01          	addl   $0x1,0x7c(%eax)
  	switchuvm(myproc());
801056af:	e8 fc df ff ff       	call   801036b0 <myproc>
801056b4:	89 04 24             	mov    %eax,(%esp)
801056b7:	e8 84 0f 00 00       	call   80106640 <switchuvm>
  	break;
801056bc:	e9 0f ff ff ff       	jmp    801055d0 <trap+0xb0>
...
8010571c:	c7 04 24 ec 75 10 80 	movl   $0x801075ec,(%esp)
...
801057c6:	e8 c5 de ff ff       	call   80103690 <cpuid>
...
801057da:	c7 04 24 10 76 10 80 	movl   $0x80107610,(%esp)
801057e1:	89 44 24 04          	mov    %eax,0x4(%esp)
801057e5:	e8 66 ae ff ff       	call   80100650 <cprintf>
      panic("trap");
801057ea:	c7 04 24 e6 75 10 80 	movl   $0x801075e6,(%esp)
...
801058e7:	00 
  for(p="xv6...\n"; *p; p++)
801058e8:	bb 50 77 10 80       	mov    $0x80107750,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105936:	6a 00                	push   $0x0
  jmp alltraps
80105938:	e9 f0 fa ff ff       	jmp    8010542d <alltraps>
...
8010593f:	6a 01                	push   $0x1
  jmp alltraps
80105941:	e9 e7 fa ff ff       	jmp    8010542d <alltraps>
...
80105948:	6a 02                	push   $0x2
  jmp alltraps
8010594a:	e9 de fa ff ff       	jmp    8010542d <alltraps>
...
80105951:	6a 03                	push   $0x3
  jmp alltraps
80105953:	e9 d5 fa ff ff       	jmp    8010542d <alltraps>
...
8010595a:	6a 04                	push   $0x4
  jmp alltraps
8010595c:	e9 cc fa ff ff       	jmp    8010542d <alltraps>
...
80105963:	6a 05                	push   $0x5
  jmp alltraps
80105965:	e9 c3 fa ff ff       	jmp    8010542d <alltraps>
...
80105985:	6a 09                	push   $0x9
  jmp alltraps
80105987:	e9 a1 fa ff ff       	jmp    8010542d <alltraps>
...
80105993:	6a 0b                	push   $0xb
  jmp alltraps
80105995:	e9 93 fa ff ff       	jmp    8010542d <alltraps>
...
801059a8:	6a 0e                	push   $0xe
  jmp alltraps
801059aa:	e9 7e fa ff ff       	jmp    8010542d <alltraps>
...
801059ca:	6a 12                	push   $0x12
  jmp alltraps
801059cc:	e9 5c fa ff ff       	jmp    8010542d <alltraps>
...
801059dc:	6a 14                	push   $0x14
  jmp alltraps
801059de:	e9 4a fa ff ff       	jmp    8010542d <alltraps>
...
801059e5:	6a 15                	push   $0x15
  jmp alltraps
801059e7:	e9 41 fa ff ff       	jmp    8010542d <alltraps>
...
801059ee:	6a 16                	push   $0x16
  jmp alltraps
801059f0:	e9 38 fa ff ff       	jmp    8010542d <alltraps>
...
801059f7:	6a 17                	push   $0x17
  jmp alltraps
801059f9:	e9 2f fa ff ff       	jmp    8010542d <alltraps>
...
80105a00:	6a 18                	push   $0x18
  jmp alltraps
80105a02:	e9 26 fa ff ff       	jmp    8010542d <alltraps>
...
80105a09:	6a 19                	push   $0x19
  jmp alltraps
80105a0b:	e9 1d fa ff ff       	jmp    8010542d <alltraps>
...
80105a12:	6a 1a                	push   $0x1a
  jmp alltraps
80105a14:	e9 14 fa ff ff       	jmp    8010542d <alltraps>
...
80105a1b:	6a 1b                	push   $0x1b
  jmp alltraps
80105a1d:	e9 0b fa ff ff       	jmp    8010542d <alltraps>
...
80105a24:	6a 1c                	push   $0x1c
  jmp alltraps
80105a26:	e9 02 fa ff ff       	jmp    8010542d <alltraps>
...
80105a2d:	6a 1d                	push   $0x1d
  jmp alltraps
80105a2f:	e9 f9 f9 ff ff       	jmp    8010542d <alltraps>
...
80105a36:	6a 1e                	push   $0x1e
  jmp alltraps
80105a38:	e9 f0 f9 ff ff       	jmp    8010542d <alltraps>
...
80105a3f:	6a 1f                	push   $0x1f
  jmp alltraps
80105a41:	e9 e7 f9 ff ff       	jmp    8010542d <alltraps>
...
80105a63:	6a 23                	push   $0x23
  jmp alltraps
80105a65:	e9 c3 f9 ff ff       	jmp    8010542d <alltraps>
...
80105a6c:	6a 24                	push   $0x24
  jmp alltraps
80105a6e:	e9 ba f9 ff ff       	jmp    8010542d <alltraps>
...
80105a75:	6a 25                	push   $0x25
  jmp alltraps
80105a77:	e9 b1 f9 ff ff       	jmp    8010542d <alltraps>
...
80105a7e:	6a 26                	push   $0x26
  jmp alltraps
80105a80:	e9 a8 f9 ff ff       	jmp    8010542d <alltraps>
...
80105a87:	6a 27                	push   $0x27
  jmp alltraps
80105a89:	e9 9f f9 ff ff       	jmp    8010542d <alltraps>
...
80105a90:	6a 28                	push   $0x28
  jmp alltraps
80105a92:	e9 96 f9 ff ff       	jmp    8010542d <alltraps>
...
80105a99:	6a 29                	push   $0x29
  jmp alltraps
80105a9b:	e9 8d f9 ff ff       	jmp    8010542d <alltraps>
...
80105aa2:	6a 2a                	push   $0x2a
  jmp alltraps
80105aa4:	e9 84 f9 ff ff       	jmp    8010542d <alltraps>
...
80105aab:	6a 2b                	push   $0x2b
  jmp alltraps
80105aad:	e9 7b f9 ff ff       	jmp    8010542d <alltraps>
...
80105ab4:	6a 2c                	push   $0x2c
  jmp alltraps
80105ab6:	e9 72 f9 ff ff       	jmp    8010542d <alltraps>
...
80105abd:	6a 2d                	push   $0x2d
  jmp alltraps
80105abf:	e9 69 f9 ff ff       	jmp    8010542d <alltraps>
...
80105ac6:	6a 2e                	push   $0x2e
  jmp alltraps
80105ac8:	e9 60 f9 ff ff       	jmp    8010542d <alltraps>
...
80105acf:	6a 2f                	push   $0x2f
  jmp alltraps
80105ad1:	e9 57 f9 ff ff       	jmp    8010542d <alltraps>
...
80105ad8:	6a 30                	push   $0x30
  jmp alltraps
80105ada:	e9 4e f9 ff ff       	jmp    8010542d <alltraps>
...
80105ae1:	6a 31                	push   $0x31
  jmp alltraps
80105ae3:	e9 45 f9 ff ff       	jmp    8010542d <alltraps>
...
80105aea:	6a 32                	push   $0x32
  jmp alltraps
80105aec:	e9 3c f9 ff ff       	jmp    8010542d <alltraps>
...
80105af3:	6a 33                	push   $0x33
  jmp alltraps
80105af5:	e9 33 f9 ff ff       	jmp    8010542d <alltraps>
...
80105afc:	6a 34                	push   $0x34
  jmp alltraps
80105afe:	e9 2a f9 ff ff       	jmp    8010542d <alltraps>
...
80105b05:	6a 35                	push   $0x35
  jmp alltraps
80105b07:	e9 21 f9 ff ff       	jmp    8010542d <alltraps>
...
80105b0e:	6a 36                	push   $0x36
  jmp alltraps
80105b10:	e9 18 f9 ff ff       	jmp    8010542d <alltraps>
...
80105b17:	6a 37                	push   $0x37
  jmp alltraps
80105b19:	e9 0f f9 ff ff       	jmp    8010542d <alltraps>
...
80105b20:	6a 38                	push   $0x38
  jmp alltraps
80105b22:	e9 06 f9 ff ff       	jmp    8010542d <alltraps>
...
80105b29:	6a 39                	push   $0x39
  jmp alltraps
80105b2b:	e9 fd f8 ff ff       	jmp    8010542d <alltraps>
...
80105b32:	6a 3a                	push   $0x3a
  jmp alltraps
80105b34:	e9 f4 f8 ff ff       	jmp    8010542d <alltraps>
...
80105b3b:	6a 3b                	push   $0x3b
  jmp alltraps
80105b3d:	e9 eb f8 ff ff       	jmp    8010542d <alltraps>
...
80105b44:	6a 3c                	push   $0x3c
  jmp alltraps
80105b46:	e9 e2 f8 ff ff       	jmp    8010542d <alltraps>
...
80105b4d:	6a 3d                	push   $0x3d
  jmp alltraps
80105b4f:	e9 d9 f8 ff ff       	jmp    8010542d <alltraps>
...
80105b56:	6a 3e                	push   $0x3e
  jmp alltraps
80105b58:	e9 d0 f8 ff ff       	jmp    8010542d <alltraps>
...
80105b5f:	6a 3f                	push   $0x3f
  jmp alltraps
80105b61:	e9 c7 f8 ff ff       	jmp    8010542d <alltraps>
...
80105b68:	6a 40                	push   $0x40
  jmp alltraps
80105b6a:	e9 be f8 ff ff       	jmp    8010542d <alltraps>
...
80105b71:	6a 41                	push   $0x41
  jmp alltraps
80105b73:	e9 b5 f8 ff ff       	jmp    8010542d <alltraps>
...
80105b7a:	6a 42                	push   $0x42
  jmp alltraps
80105b7c:	e9 ac f8 ff ff       	jmp    8010542d <alltraps>
...
80105b83:	6a 43                	push   $0x43
  jmp alltraps
80105b85:	e9 a3 f8 ff ff       	jmp    8010542d <alltraps>
...
80105b8c:	6a 44                	push   $0x44
  jmp alltraps
80105b8e:	e9 9a f8 ff ff       	jmp    8010542d <alltraps>
...
80105b95:	6a 45                	push   $0x45
  jmp alltraps
80105b97:	e9 91 f8 ff ff       	jmp    8010542d <alltraps>
...
80105b9e:	6a 46                	push   $0x46
  jmp alltraps
80105ba0:	e9 88 f8 ff ff       	jmp    8010542d <alltraps>
...
80105ba7:	6a 47                	push   $0x47
  jmp alltraps
80105ba9:	e9 7f f8 ff ff       	jmp    8010542d <alltraps>
...
80105bb0:	6a 48                	push   $0x48
  jmp alltraps
80105bb2:	e9 76 f8 ff ff       	jmp    8010542d <alltraps>
...
80105bb9:	6a 49                	push   $0x49
  jmp alltraps
80105bbb:	e9 6d f8 ff ff       	jmp    8010542d <alltraps>
...
80105bc2:	6a 4a                	push   $0x4a
  jmp alltraps
80105bc4:	e9 64 f8 ff ff       	jmp    8010542d <alltraps>
...
80105bcb:	6a 4b                	push   $0x4b
  jmp alltraps
80105bcd:	e9 5b f8 ff ff       	jmp    8010542d <alltraps>
...
80105bd4:	6a 4c                	push   $0x4c
  jmp alltraps
80105bd6:	e9 52 f8 ff ff       	jmp    8010542d <alltraps>
...
80105bdd:	6a 4d                	push   $0x4d
  jmp alltraps
80105bdf:	e9 49 f8 ff ff       	jmp    8010542d <alltraps>
...
80105be6:	6a 4e                	push   $0x4e
  jmp alltraps
80105be8:	e9 40 f8 ff ff       	jmp    8010542d <alltraps>
...
80105bef:	6a 4f                	push   $0x4f
  jmp alltraps
80105bf1:	e9 37 f8 ff ff       	jmp    8010542d <alltraps>
...
80105bf8:	6a 50                	push   $0x50
  jmp alltraps
80105bfa:	e9 2e f8 ff ff       	jmp    8010542d <alltraps>
...
80105c01:	6a 51                	push   $0x51
  jmp alltraps
80105c03:	e9 25 f8 ff ff       	jmp    8010542d <alltraps>
...
80105c0a:	6a 52                	push   $0x52
  jmp alltraps
80105c0c:	e9 1c f8 ff ff       	jmp    8010542d <alltraps>
...
80105c13:	6a 53                	push   $0x53
  jmp alltraps
80105c15:	e9 13 f8 ff ff       	jmp    8010542d <alltraps>
...
80105c1c:	6a 54                	push   $0x54
  jmp alltraps
80105c1e:	e9 0a f8 ff ff       	jmp    8010542d <alltraps>
...
80105c25:	6a 55                	push   $0x55
  jmp alltraps
80105c27:	e9 01 f8 ff ff       	jmp    8010542d <alltraps>
...
80105c2e:	6a 56                	push   $0x56
  jmp alltraps
80105c30:	e9 f8 f7 ff ff       	jmp    8010542d <alltraps>
...
80105c37:	6a 57                	push   $0x57
  jmp alltraps
80105c39:	e9 ef f7 ff ff       	jmp    8010542d <alltraps>
...
80105c40:	6a 58                	push   $0x58
  jmp alltraps
80105c42:	e9 e6 f7 ff ff       	jmp    8010542d <alltraps>
...
80105c49:	6a 59                	push   $0x59
  jmp alltraps
80105c4b:	e9 dd f7 ff ff       	jmp    8010542d <alltraps>
...
80105c52:	6a 5a                	push   $0x5a
  jmp alltraps
80105c54:	e9 d4 f7 ff ff       	jmp    8010542d <alltraps>
...
80105c5b:	6a 5b                	push   $0x5b
  jmp alltraps
80105c5d:	e9 cb f7 ff ff       	jmp    8010542d <alltraps>
...
80105c64:	6a 5c                	push   $0x5c
  jmp alltraps
80105c66:	e9 c2 f7 ff ff       	jmp    8010542d <alltraps>
...
80105c6d:	6a 5d                	push   $0x5d
  jmp alltraps
80105c6f:	e9 b9 f7 ff ff       	jmp    8010542d <alltraps>
...
80105c76:	6a 5e                	push   $0x5e
  jmp alltraps
80105c78:	e9 b0 f7 ff ff       	jmp    8010542d <alltraps>
...
80105c7f:	6a 5f                	push   $0x5f
  jmp alltraps
80105c81:	e9 a7 f7 ff ff       	jmp    8010542d <alltraps>
...
80105c88:	6a 60                	push   $0x60
  jmp alltraps
80105c8a:	e9 9e f7 ff ff       	jmp    8010542d <alltraps>
...
80105c91:	6a 61                	push   $0x61
  jmp alltraps
80105c93:	e9 95 f7 ff ff       	jmp    8010542d <alltraps>
...
80105c9a:	6a 62                	push   $0x62
  jmp alltraps
80105c9c:	e9 8c f7 ff ff       	jmp    8010542d <alltraps>
...
80105ca3:	6a 63                	push   $0x63
  jmp alltraps
80105ca5:	e9 83 f7 ff ff       	jmp    8010542d <alltraps>
...
80105cac:	6a 64                	push   $0x64
  jmp alltraps
80105cae:	e9 7a f7 ff ff       	jmp    8010542d <alltraps>
...
80105cb5:	6a 65                	push   $0x65
  jmp alltraps
80105cb7:	e9 71 f7 ff ff       	jmp    8010542d <alltraps>
...
80105cbe:	6a 66                	push   $0x66
  jmp alltraps
80105cc0:	e9 68 f7 ff ff       	jmp    8010542d <alltraps>
...
80105cc7:	6a 67                	push   $0x67
  jmp alltraps
80105cc9:	e9 5f f7 ff ff       	jmp    8010542d <alltraps>
...
80105cd0:	6a 68                	push   $0x68
  jmp alltraps
80105cd2:	e9 56 f7 ff ff       	jmp    8010542d <alltraps>
...
80105cd9:	6a 69                	push   $0x69
  jmp alltraps
80105cdb:	e9 4d f7 ff ff       	jmp    8010542d <alltraps>
...
80105ce2:	6a 6a                	push   $0x6a
  jmp alltraps
80105ce4:	e9 44 f7 ff ff       	jmp    8010542d <alltraps>
...
80105ceb:	6a 6b                	push   $0x6b
  jmp alltraps
80105ced:	e9 3b f7 ff ff       	jmp    8010542d <alltraps>
...
80105cf4:	6a 6c                	push   $0x6c
  jmp alltraps
80105cf6:	e9 32 f7 ff ff       	jmp    8010542d <alltraps>
...
80105cfd:	6a 6d                	push   $0x6d
  jmp alltraps
80105cff:	e9 29 f7 ff ff       	jmp    8010542d <alltraps>
...
80105d06:	6a 6e                	push   $0x6e
  jmp alltraps
80105d08:	e9 20 f7 ff ff       	jmp    8010542d <alltraps>
...
80105d0f:	6a 6f                	push   $0x6f
  jmp alltraps
80105d11:	e9 17 f7 ff ff       	jmp    8010542d <alltraps>
...
80105d18:	6a 70                	push   $0x70
  jmp alltraps
80105d1a:	e9 0e f7 ff ff       	jmp    8010542d <alltraps>
...
80105d21:	6a 71                	push   $0x71
  jmp alltraps
80105d23:	e9 05 f7 ff ff       	jmp    8010542d <alltraps>
...
80105d2a:	6a 72                	push   $0x72
  jmp alltraps
80105d2c:	e9 fc f6 ff ff       	jmp    8010542d <alltraps>
...
80105d33:	6a 73                	push   $0x73
  jmp alltraps
80105d35:	e9 f3 f6 ff ff       	jmp    8010542d <alltraps>
...
80105d3c:	6a 74                	push   $0x74
  jmp alltraps
80105d3e:	e9 ea f6 ff ff       	jmp    8010542d <alltraps>
...
80105d45:	6a 75                	push   $0x75
  jmp alltraps
80105d47:	e9 e1 f6 ff ff       	jmp    8010542d <alltraps>
...
80105d4e:	6a 76                	push   $0x76
  jmp alltraps
80105d50:	e9 d8 f6 ff ff       	jmp    8010542d <alltraps>
...
80105d57:	6a 77                	push   $0x77
  jmp alltraps
80105d59:	e9 cf f6 ff ff       	jmp    8010542d <alltraps>
...
80105d60:	6a 78                	push   $0x78
  jmp alltraps
80105d62:	e9 c6 f6 ff ff       	jmp    8010542d <alltraps>
...
80105d69:	6a 79                	push   $0x79
  jmp alltraps
80105d6b:	e9 bd f6 ff ff       	jmp    8010542d <alltraps>
...
80105d72:	6a 7a                	push   $0x7a
  jmp alltraps
80105d74:	e9 b4 f6 ff ff       	jmp    8010542d <alltraps>
...
80105d7b:	6a 7b                	push   $0x7b
  jmp alltraps
80105d7d:	e9 ab f6 ff ff       	jmp    8010542d <alltraps>
...
80105d84:	6a 7c                	push   $0x7c
  jmp alltraps
80105d86:	e9 a2 f6 ff ff       	jmp    8010542d <alltraps>
...
80105d8d:	6a 7d                	push   $0x7d
  jmp alltraps
80105d8f:	e9 99 f6 ff ff       	jmp    8010542d <alltraps>
...
80105d96:	6a 7e                	push   $0x7e
  jmp alltraps
80105d98:	e9 90 f6 ff ff       	jmp    8010542d <alltraps>
...
80105d9f:	6a 7f                	push   $0x7f
  jmp alltraps
80105da1:	e9 87 f6 ff ff       	jmp    8010542d <alltraps>
...
80105da8:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105dad:	e9 7b f6 ff ff       	jmp    8010542d <alltraps>
...
80105db4:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105db9:	e9 6f f6 ff ff       	jmp    8010542d <alltraps>
...
80105dc0:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105dc5:	e9 63 f6 ff ff       	jmp    8010542d <alltraps>
...
80105dcc:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105dd1:	e9 57 f6 ff ff       	jmp    8010542d <alltraps>
...
80105dd8:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105ddd:	e9 4b f6 ff ff       	jmp    8010542d <alltraps>
...
80105de4:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80105de9:	e9 3f f6 ff ff       	jmp    8010542d <alltraps>
...
80105df0:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80105df5:	e9 33 f6 ff ff       	jmp    8010542d <alltraps>
...
80105dfc:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80105e01:	e9 27 f6 ff ff       	jmp    8010542d <alltraps>
...
80105e08:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80105e0d:	e9 1b f6 ff ff       	jmp    8010542d <alltraps>
...
80105e14:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80105e19:	e9 0f f6 ff ff       	jmp    8010542d <alltraps>
...
80105e20:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80105e25:	e9 03 f6 ff ff       	jmp    8010542d <alltraps>
...
80105e2c:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80105e31:	e9 f7 f5 ff ff       	jmp    8010542d <alltraps>
...
80105e38:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80105e3d:	e9 eb f5 ff ff       	jmp    8010542d <alltraps>
...
80105e44:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80105e49:	e9 df f5 ff ff       	jmp    8010542d <alltraps>
...
80105e50:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80105e55:	e9 d3 f5 ff ff       	jmp    8010542d <alltraps>
...
80105e5c:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80105e61:	e9 c7 f5 ff ff       	jmp    8010542d <alltraps>
...
80105e68:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80105e6d:	e9 bb f5 ff ff       	jmp    8010542d <alltraps>
...
80105e74:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80105e79:	e9 af f5 ff ff       	jmp    8010542d <alltraps>
...
80105e80:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80105e85:	e9 a3 f5 ff ff       	jmp    8010542d <alltraps>
...
80105e8c:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80105e91:	e9 97 f5 ff ff       	jmp    8010542d <alltraps>
...
80105e98:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80105e9d:	e9 8b f5 ff ff       	jmp    8010542d <alltraps>
...
80105ea4:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80105ea9:	e9 7f f5 ff ff       	jmp    8010542d <alltraps>
...
80105eb0:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80105eb5:	e9 73 f5 ff ff       	jmp    8010542d <alltraps>
...
80105ebc:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80105ec1:	e9 67 f5 ff ff       	jmp    8010542d <alltraps>
...
80105ec8:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80105ecd:	e9 5b f5 ff ff       	jmp    8010542d <alltraps>
...
80105ed4:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80105ed9:	e9 4f f5 ff ff       	jmp    8010542d <alltraps>
...
80105ee0:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80105ee5:	e9 43 f5 ff ff       	jmp    8010542d <alltraps>
...
80105eec:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80105ef1:	e9 37 f5 ff ff       	jmp    8010542d <alltraps>
...
80105ef8:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80105efd:	e9 2b f5 ff ff       	jmp    8010542d <alltraps>
...
80105f04:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80105f09:	e9 1f f5 ff ff       	jmp    8010542d <alltraps>
...
80105f10:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80105f15:	e9 13 f5 ff ff       	jmp    8010542d <alltraps>
...
80105f1c:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80105f21:	e9 07 f5 ff ff       	jmp    8010542d <alltraps>
...
80105f28:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80105f2d:	e9 fb f4 ff ff       	jmp    8010542d <alltraps>
...
80105f34:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80105f39:	e9 ef f4 ff ff       	jmp    8010542d <alltraps>
...
80105f40:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80105f45:	e9 e3 f4 ff ff       	jmp    8010542d <alltraps>
...
80105f4c:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80105f51:	e9 d7 f4 ff ff       	jmp    8010542d <alltraps>
...
80105f58:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80105f5d:	e9 cb f4 ff ff       	jmp    8010542d <alltraps>
...
80105f64:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80105f69:	e9 bf f4 ff ff       	jmp    8010542d <alltraps>
...
80105f70:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80105f75:	e9 b3 f4 ff ff       	jmp    8010542d <alltraps>
...
80105f7c:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80105f81:	e9 a7 f4 ff ff       	jmp    8010542d <alltraps>
...
80105f88:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80105f8d:	e9 9b f4 ff ff       	jmp    8010542d <alltraps>
...
80105f94:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80105f99:	e9 8f f4 ff ff       	jmp    8010542d <alltraps>
...
80105fa0:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80105fa5:	e9 83 f4 ff ff       	jmp    8010542d <alltraps>
...
80105fac:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80105fb1:	e9 77 f4 ff ff       	jmp    8010542d <alltraps>
...
80105fb8:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80105fbd:	e9 6b f4 ff ff       	jmp    8010542d <alltraps>
...
80105fc4:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80105fc9:	e9 5f f4 ff ff       	jmp    8010542d <alltraps>
...
80105fd0:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80105fd5:	e9 53 f4 ff ff       	jmp    8010542d <alltraps>
...
80105fdc:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80105fe1:	e9 47 f4 ff ff       	jmp    8010542d <alltraps>
...
80105fe8:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80105fed:	e9 3b f4 ff ff       	jmp    8010542d <alltraps>
...
80105ff4:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80105ff9:	e9 2f f4 ff ff       	jmp    8010542d <alltraps>
...
80106000:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106005:	e9 23 f4 ff ff       	jmp    8010542d <alltraps>
...
8010600c:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106011:	e9 17 f4 ff ff       	jmp    8010542d <alltraps>
...
80106018:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010601d:	e9 0b f4 ff ff       	jmp    8010542d <alltraps>
...
80106024:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80106029:	e9 ff f3 ff ff       	jmp    8010542d <alltraps>
...
80106030:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106035:	e9 f3 f3 ff ff       	jmp    8010542d <alltraps>
...
8010603c:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106041:	e9 e7 f3 ff ff       	jmp    8010542d <alltraps>
...
80106048:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010604d:	e9 db f3 ff ff       	jmp    8010542d <alltraps>
...
80106054:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80106059:	e9 cf f3 ff ff       	jmp    8010542d <alltraps>
...
80106060:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106065:	e9 c3 f3 ff ff       	jmp    8010542d <alltraps>
...
8010606c:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106071:	e9 b7 f3 ff ff       	jmp    8010542d <alltraps>
...
80106078:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010607d:	e9 ab f3 ff ff       	jmp    8010542d <alltraps>
...
80106084:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80106089:	e9 9f f3 ff ff       	jmp    8010542d <alltraps>
...
80106090:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106095:	e9 93 f3 ff ff       	jmp    8010542d <alltraps>
...
8010609c:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801060a1:	e9 87 f3 ff ff       	jmp    8010542d <alltraps>
...
801060a8:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801060ad:	e9 7b f3 ff ff       	jmp    8010542d <alltraps>
...
801060b4:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801060b9:	e9 6f f3 ff ff       	jmp    8010542d <alltraps>
...
801060c0:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801060c5:	e9 63 f3 ff ff       	jmp    8010542d <alltraps>
...
801060cc:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801060d1:	e9 57 f3 ff ff       	jmp    8010542d <alltraps>
...
801060d8:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801060dd:	e9 4b f3 ff ff       	jmp    8010542d <alltraps>
...
801060e4:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801060e9:	e9 3f f3 ff ff       	jmp    8010542d <alltraps>
...
801060f0:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801060f5:	e9 33 f3 ff ff       	jmp    8010542d <alltraps>
...
801060fc:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106101:	e9 27 f3 ff ff       	jmp    8010542d <alltraps>
...
80106108:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010610d:	e9 1b f3 ff ff       	jmp    8010542d <alltraps>
...
80106114:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106119:	e9 0f f3 ff ff       	jmp    8010542d <alltraps>
...
80106120:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106125:	e9 03 f3 ff ff       	jmp    8010542d <alltraps>
...
8010612c:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106131:	e9 f7 f2 ff ff       	jmp    8010542d <alltraps>
...
80106138:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010613d:	e9 eb f2 ff ff       	jmp    8010542d <alltraps>
...
80106144:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80106149:	e9 df f2 ff ff       	jmp    8010542d <alltraps>
...
80106150:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106155:	e9 d3 f2 ff ff       	jmp    8010542d <alltraps>
...
8010615c:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106161:	e9 c7 f2 ff ff       	jmp    8010542d <alltraps>
...
80106168:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010616d:	e9 bb f2 ff ff       	jmp    8010542d <alltraps>
...
80106174:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80106179:	e9 af f2 ff ff       	jmp    8010542d <alltraps>
...
80106180:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106185:	e9 a3 f2 ff ff       	jmp    8010542d <alltraps>
...
8010618c:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106191:	e9 97 f2 ff ff       	jmp    8010542d <alltraps>
...
80106198:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010619d:	e9 8b f2 ff ff       	jmp    8010542d <alltraps>
...
801061a4:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801061a9:	e9 7f f2 ff ff       	jmp    8010542d <alltraps>
...
801061b0:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801061b5:	e9 73 f2 ff ff       	jmp    8010542d <alltraps>
...
801061bc:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801061c1:	e9 67 f2 ff ff       	jmp    8010542d <alltraps>
...
801061c8:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801061cd:	e9 5b f2 ff ff       	jmp    8010542d <alltraps>
...
801061d4:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801061d9:	e9 4f f2 ff ff       	jmp    8010542d <alltraps>
...
801061e0:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801061e5:	e9 43 f2 ff ff       	jmp    8010542d <alltraps>
...
801061ec:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801061f1:	e9 37 f2 ff ff       	jmp    8010542d <alltraps>
...
801061f8:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801061fd:	e9 2b f2 ff ff       	jmp    8010542d <alltraps>
...
80106204:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106209:	e9 1f f2 ff ff       	jmp    8010542d <alltraps>
...
80106210:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106215:	e9 13 f2 ff ff       	jmp    8010542d <alltraps>
...
8010621c:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106221:	e9 07 f2 ff ff       	jmp    8010542d <alltraps>
...
80106228:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010622d:	e9 fb f1 ff ff       	jmp    8010542d <alltraps>
...
80106234:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106239:	e9 ef f1 ff ff       	jmp    8010542d <alltraps>
...
80106240:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106245:	e9 e3 f1 ff ff       	jmp    8010542d <alltraps>
...
8010624c:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106251:	e9 d7 f1 ff ff       	jmp    8010542d <alltraps>
...
80106258:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010625d:	e9 cb f1 ff ff       	jmp    8010542d <alltraps>
...
80106264:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106269:	e9 bf f1 ff ff       	jmp    8010542d <alltraps>
...
80106270:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106275:	e9 b3 f1 ff ff       	jmp    8010542d <alltraps>
...
8010627c:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106281:	e9 a7 f1 ff ff       	jmp    8010542d <alltraps>
...
80106288:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010628d:	e9 9b f1 ff ff       	jmp    8010542d <alltraps>
...
80106294:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106299:	e9 8f f1 ff ff       	jmp    8010542d <alltraps>
...
801062a0:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801062a5:	e9 83 f1 ff ff       	jmp    8010542d <alltraps>
...
801062ac:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801062b1:	e9 77 f1 ff ff       	jmp    8010542d <alltraps>
...
801062b8:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801062bd:	e9 6b f1 ff ff       	jmp    8010542d <alltraps>
...
801062c4:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801062c9:	e9 5f f1 ff ff       	jmp    8010542d <alltraps>
...
801062d0:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801062d5:	e9 53 f1 ff ff       	jmp    8010542d <alltraps>
...
801062dc:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801062e1:	e9 47 f1 ff ff       	jmp    8010542d <alltraps>
...
801062e8:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801062ed:	e9 3b f1 ff ff       	jmp    8010542d <alltraps>
...
801062f4:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801062f9:	e9 2f f1 ff ff       	jmp    8010542d <alltraps>
...
80106300:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106305:	e9 23 f1 ff ff       	jmp    8010542d <alltraps>
...
8010630c:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106311:	e9 17 f1 ff ff       	jmp    8010542d <alltraps>
...
80106318:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010631d:	e9 0b f1 ff ff       	jmp    8010542d <alltraps>
...
80106324:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106329:	e9 ff f0 ff ff       	jmp    8010542d <alltraps>
...
80106330:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106335:	e9 f3 f0 ff ff       	jmp    8010542d <alltraps>
...
8010633c:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106341:	e9 e7 f0 ff ff       	jmp    8010542d <alltraps>
...
80106348:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010634d:	e9 db f0 ff ff       	jmp    8010542d <alltraps>
...
80106354:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106359:	e9 cf f0 ff ff       	jmp    8010542d <alltraps>
...
80106360:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106365:	e9 c3 f0 ff ff       	jmp    8010542d <alltraps>
...
8010636c:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106371:	e9 b7 f0 ff ff       	jmp    8010542d <alltraps>
...
80106378:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010637d:	e9 ab f0 ff ff       	jmp    8010542d <alltraps>
...
80106384:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106389:	e9 9f f0 ff ff       	jmp    8010542d <alltraps>
...
80106390:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106395:	e9 93 f0 ff ff       	jmp    8010542d <alltraps>
...
8010639c:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801063a1:	e9 87 f0 ff ff       	jmp    8010542d <alltraps>
...
801064ca:	c3                   	ret    
        panic("kfree");
801064cb:	c7 04 24 a6 70 10 80 	movl   $0x801070a6,(%esp)
...
80106611:	c3                   	ret    
      panic("remap");
80106612:	c7 04 24 58 77 10 80 	movl   $0x80107758,(%esp)
...
80106721:	c7 04 24 5e 77 10 80 	movl   $0x8010775e,(%esp)
80106728:	e8 33 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no pgdir");
8010672d:	c7 04 24 89 77 10 80 	movl   $0x80107789,(%esp)
80106734:	e8 27 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no kstack");
80106739:	c7 04 24 74 77 10 80 	movl   $0x80107774,(%esp)
...
801067ce:	c7 04 24 9d 77 10 80 	movl   $0x8010779d,(%esp)
...
80106882:	c7 04 24 b7 77 10 80 	movl   $0x801077b7,(%esp)
80106889:	e8 d2 9a ff ff       	call   80100360 <panic>
    panic("loaduvm: addr must be page aligned");
8010688e:	c7 04 24 58 78 10 80 	movl   $0x80107858,(%esp)
...
80106932:	c7 04 24 d5 77 10 80 	movl   $0x801077d5,(%esp)
...
80106960:	c7 04 24 ed 77 10 80 	movl   $0x801077ed,(%esp)
...
80106a23:	e9 d8 b8 ff ff       	jmp    80102300 <kfree>
    panic("freevm: no pgdir");
80106a28:	c7 04 24 09 78 10 80 	movl   $0x80107809,(%esp)
...
80106b0b:	c3                   	ret    
    panic("clearpteu");
80106b0c:	c7 04 24 1a 78 10 80 	movl   $0x8010781a,(%esp)
...
// of it for a child.
pde_t*
copyuvm(pde_t *pgdir, uint sz, uint stkpages)
{
...
80106b33:	0f 84 86 01 00 00    	je     80106cbf <copyuvm+0x19f>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
...
80106ba7:	0f 84 25 01 00 00    	je     80106cd2 <copyuvm+0x1b2>
    if(!(*pte & PTE_P))
80106bad:	8b 30                	mov    (%eax),%esi
80106baf:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106bb5:	0f 84 0b 01 00 00    	je     80106cc6 <copyuvm+0x1a6>
    pa = PTE_ADDR(*pte);
...
80106bf3:	f7 d8                	neg    %eax
80106bf5:	c1 e0 0c             	shl    $0xc,%eax
80106bf8:	8d 98 00 f0 ff 7f    	lea    0x7ffff000(%eax),%ebx
80106bfe:	81 fb ff ef ff 7f    	cmp    $0x7fffefff,%ebx
80106c04:	0f 87 aa 00 00 00    	ja     80106cb4 <copyuvm+0x194>
80106c0a:	89 c2                	mov    %eax,%edx
80106c0c:	f7 d2                	not    %edx
80106c0e:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
80106c14:	8d 84 10 00 00 00 80 	lea    -0x80000000(%eax,%edx,1),%eax
80106c1b:	89 45 dc             	mov    %eax,-0x24(%ebp)
80106c1e:	eb 55                	jmp    80106c75 <copyuvm+0x155>
    memmove(mem, (char*)P2V(pa), PGSIZE);
...
80106c5d:	e8 3e f9 ff ff       	call   801065a0 <mappages>
80106c62:	85 c0                	test   %eax,%eax
80106c64:	0f 88 71 ff ff ff    	js     80106bdb <copyuvm+0xbb>
  for(i = NEWPG - (stkpages * PGSIZE); i < NEWPG; i += PGSIZE){
80106c6a:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106c70:	3b 5d dc             	cmp    -0x24(%ebp),%ebx
80106c73:	74 3f                	je     80106cb4 <copyuvm+0x194>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106c75:	8b 45 08             	mov    0x8(%ebp),%eax
80106c78:	31 c9                	xor    %ecx,%ecx
80106c7a:	89 da                	mov    %ebx,%edx
80106c7c:	e8 2f f7 ff ff       	call   801063b0 <walkpgdir>
80106c81:	85 c0                	test   %eax,%eax
80106c83:	74 4d                	je     80106cd2 <copyuvm+0x1b2>
    if(!(*pte & PTE_P))
80106c85:	8b 30                	mov    (%eax),%esi
80106c87:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106c8d:	74 37                	je     80106cc6 <copyuvm+0x1a6>
    pa = PTE_ADDR(*pte);
...
80106c9a:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80106ca0:	e8 0b b8 ff ff       	call   801024b0 <kalloc>
80106ca5:	85 c0                	test   %eax,%eax
80106ca7:	89 c6                	mov    %eax,%esi
80106ca9:	0f 85 71 ff ff ff    	jne    80106c20 <copyuvm+0x100>
80106caf:	e9 27 ff ff ff       	jmp    80106bdb <copyuvm+0xbb>
80106cb4:	8b 45 e0             	mov    -0x20(%ebp),%eax
}
80106cb7:	83 c4 2c             	add    $0x2c,%esp
80106cba:	5b                   	pop    %ebx
80106cbb:	5e                   	pop    %esi
80106cbc:	5f                   	pop    %edi
80106cbd:	5d                   	pop    %ebp
...
80106cc1:	e9 22 ff ff ff       	jmp    80106be8 <copyuvm+0xc8>
      panic("copyuvm: page not present");
80106cc6:	c7 04 24 3e 78 10 80 	movl   $0x8010783e,(%esp)
80106ccd:	e8 8e 96 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106cd2:	c7 04 24 24 78 10 80 	movl   $0x80107824,(%esp)
...
80106cee:	e8 bd f6 ff ff       	call   801063b0 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80106d5c:	e8 cf d5 ff ff       	call   80104330 <memmove>
    len -= n;
    buf += n;
...
80106db6:	c7 44 24 04 7c 78 10 	movl   $0x8010787c,0x4(%esp)
80106dbd:	80 
80106dbe:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106dc5:	e8 96 d2 ff ff       	call   80104060 <initlock>
  acquire(&(shm_table.lock));
80106dca:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106dd1:	e8 7a d3 ff ff       	call   80104150 <acquire>
...
80106e05:	e8 36 d4 ff ff       	call   80104240 <release>
}
80106e0a:	c9                   	leave  
80106e0b:	c3                   	ret    
